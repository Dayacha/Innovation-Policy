...
_COUNTRY_SCAN_HINTS: dict[str, str] = {
    ...
    "Turkey": (
        ...
        "(4) 'kanuntbmmc09XXXXX.pdf' AND 'Malî-Yılı-Bütçe-Kanunu-Kanun-No-XXXX.pdf' = "
        "budget law articles only (fiscal policy rules, procurement provisions) — "
        "NO appropriation tables, NO TÜBİTAK/TÜBA/TAEK amounts — mark ALL pages relevant=false. "
        "(5) UUID-named scanned PDFs (e.g. 'dfd35a0d-...pdf', 'ffe059e8-...pdf', 'f8229ba6-...pdf') "
        "for years 2001-2004 = also budget law articles only (verified: OCR text contains only "
        "fiscal policy clauses, NOT the Cetveller/appropriation schedules) — mark ALL pages relevant=false. "
        "(6) '2-a-XXXX-Yılı-Genel-Bütçeli-İdareler-Ekonomik-Kod-İcmali' (3-page files, "
        "2010-2025) = General Budget economic-code summary, NO TÜBİTAK/TÜBA/TAEK — "
        "mark ALL pages relevant=false. "
        "(7) Numbered Resmi Gazete files for 1984-1999 (e.g. '1984 18230.pdf', '1985 18622.pdf', "
        "'1986 18975.pdf' through '1999 23741.pdf') = Resmi Gazete issues containing health "
        "regulations, labor laws, court notices — NOT the budget appropriation schedule. "
        "These do NOT contain TÜBİTAK/TÜBA/TAEK. Mark ALL pages relevant=false. "
        "BEST FILES (actually contain Cetveller/appropriation tables): "
        "multi-hundred-page numbered Resmi Gazete files for 1975-1983 (e.g. '1981 17265.pdf', ~400p), "
        "'ButceGerekcesi_XXXX.pdf' (budget justification, 200-400p), "
        "'efe3d60d-...pdf' (2007, contains appropriation tables). "
