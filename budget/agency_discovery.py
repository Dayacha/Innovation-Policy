...
_COUNTRY_NOISE_PATTERNS: dict[str, list[re.Pattern]] = {
    ...
    "Chile": [
        re.compile(r"^Servicio Local de Educaci[oó]n\b", re.IGNORECASE),
        re.compile(r"^Junta Nacional de\b", re.IGNORECASE),
        re.compile(r"^Superintendencia de Educaci[oó]n\b", re.IGNORECASE),
        re.compile(r"^Agencia de Calidad de la Educaci[oó]n\b", re.IGNORECASE),
        re.compile(r"^Polic[ií]a de Investigaciones de Chile\b", re.IGNORECASE),
        re.compile(r"^Gobierno Regional\b", re.IGNORECASE),
        re.compile(r"^Patentes de Acuicultura\b", re.IGNORECASE),
        re.compile(r"^Subsecretar[ií]a de Educaci[oó]n\b", re.IGNORECASE),
        re.compile(r"^Subsecretar[ií]a de Redes Asistenciales\b", re.IGNORECASE),
        re.compile(r"^Fondo Nacional de Salud\b", re.IGNORECASE),
    ],
    "Belgium": [
        re.compile(r"^Wetenschapsbeleid$", re.IGNORECASE),
        re.compile(r"^Politique scientifique$", re.IGNORECASE),
        re.compile(r"^Scientific Policy$", re.IGNORECASE),
        re.compile(r"^POD Wetenschapsbeleid$", re.IGNORECASE),
        re.compile(r"^SPP Politique scientifique$", re.IGNORECASE),
        re.compile(r"^Diensten voor Programmatie van het Wetenschapsbeleid$", re.IGNORECASE),
        re.compile(r"^Services de Programmation de la Politique Scientifique$", re.IGNORECASE),
        re.compile(r"^Services du Premier Ministre$", re.IGNORECASE),
        re.compile(r"^Diensten van de Eerste Minister$", re.IGNORECASE),
        re.compile(r"^Divers$", re.IGNORECASE),
        re.compile(r"^Recettes diverses$", re.IGNORECASE),
        re.compile(r"^HOOFDSTUK\s+\d+\b", re.IGNORECASE),
        re.compile(r"^CHAPITRE\s+\d+\b", re.IGNORECASE),
        re.compile(r"^PROGRAMMA\s+\d+/\d+\b", re.IGNORECASE),
        re.compile(r"^PROGRAMME\s+\d+/\d+\b", re.IGNORECASE),
        re.compile(r"^AFDELING\s+\d+\b", re.IGNORECASE),
        re.compile(r"^DIVISION\s+\d+\b", re.IGNORECASE),
        re.compile(r"^R[\s.\-&]*D[\s.\-&]*(OP|AU|DANS|AT)\b", re.IGNORECASE),
        re.compile(r"^RESEARCH[\s—-]*DEVELOPMENT\b", re.IGNORECASE),
        re.compile(r"^Onderzoek en Ontwikkeling op (nationaal|internationaal) vlak$", re.IGNORECASE),
        re.compile(r"^Totals? for the (program|organizational department)\b", re.IGNORECASE),
        re.compile(r"^Total expenditures$", re.IGNORECASE),
        re.compile(r"^Operating funds$", re.IGNORECASE),
        re.compile(r"^Scientific Institution \(I\.H\.E\.\)$", re.IGNORECASE),
        re.compile(r"^Research and development in the international framework\.?$", re.IGNORECASE),
        re.compile(r"^Funding for studies, research, publications, and assignments for third parties\.?$", re.IGNORECASE),
        re.compile(r"^Studies and research in the field of energy as a continuation of the national R&D Energy program$", re.IGNORECASE),
        re.compile(r"^Centers for anthropogenetics$", re.IGNORECASE),
        re.compile(r"^Laboratory costs$", re.IGNORECASE),
        re.compile(r"^Activit[eé]s spatiales$", re.IGNORECASE),
        re.compile(r"^Collaborations internationales diverses$", re.IGNORECASE),
        re.compile(r"^Subsidies? en dotaties? aan externe organismen$", re.IGNORECASE),
        re.compile(r"^Subventions? [aà] des organismes externes$", re.IGNORECASE),
        re.compile(r"^Federale wetenschappelijke instellingen en daarmee gelijkgestelde instellingen$", re.IGNORECASE),
        re.compile(r"^Etablissements scientifiques f[eé]d[eé]raux et assimil[eé]s$", re.IGNORECASE),
        re.compile(r"^Onderzoeks.? en Ontwikkelingssector$", re.IGNORECASE),
        re.compile(r"^Nationaal Research$", re.IGNORECASE),
    ],
}
...
def discover_agencies(
    ...
    for _, row in new_candidates.iterrows():
        ...
        agency_entry = {
            ...
            "active_years": (int(row["year_min"]), int(row["year_max"])),
